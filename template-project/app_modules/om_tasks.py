...
# Tasks to interact with ACE site's VALO Order Management app

class OMTasks:

    def get_site_page(self, appian: AppianClient, site_name: str, page_name: str) -> 'SailUiForm':
        site_form = None
    ...
    # def create_engagement_from_engagements_page_then_refresh_engagements(self, site_page: SailUiForm) -> SailUiForm:
    #     try: 
